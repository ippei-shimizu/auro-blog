...
<footer class="footer">
  <div class="footer-inner">
    ...
    <div class="footer-info">
      <p class="company-name">アウロジャパン株式会社</p>
      ...
      <ul class="footer-sns">
        ...
        <li><a href="https://lin.ee/iNfFhI6" target="_blank">
          <img src="<?php echo $global_image_path ?>icon-line.svg" alt="LINE" width="52" height="52">
        </a></li>
      </ul>
    </div>
  ...
  <div class="footer-btm">
    <p>&copy;AURO JAPAN INC.</p>
    <p>produce by parabola inc / illustration by シロ</p>
  </div>
</footer>
